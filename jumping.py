...
while running:
    ...
    for event in pygame.event.get():
        ...
        original_image = player_image_rect
    ...
    if keys[pygame.K_SPACE] and is_jumping:  
        ...
        player_image = jumping_player_image
    ...
    if facing == "left":
            player_image = pygame.transform.flip(player_image_rect, True, False)
    ...
    if event.type == pygame.MOUSEBUTTONDOWN:
        if event.button == 1:  # left click
            # changes image
            player_image = punching_player_image
